...
int main() {
  ...
  assert(diff.find("max_component_risk_level=") != std::string::npos);
  ...
  assert(diff.find("receiver_raw_rms_delta_ratio=") != std::string::npos);
  assert(diff.find("receiver_comp_rms_delta_ratio=") != std::string::npos);
  assert(diff.find("sparameter_rms_delta_ratio=") != std::string::npos);
  ...
  assert(diff.find("receiver_raw_max_component=") != std::string::npos);
  assert(diff.find("receiver_comp_max_component=") != std::string::npos);
  assert(diff.find("sparameter_max_component=") != std::string::npos);
  assert(diff.find("receiver_raw_max_component_margin=") != std::string::npos);
  assert(diff.find("receiver_comp_max_component_margin=") != std::string::npos);
  assert(diff.find("sparameter_max_component_margin=") != std::string::npos);
  assert(diff.find("receiver_raw_max_frequency_hz=") != std::string::npos);
  assert(diff.find("receiver_comp_max_frequency_hz=") != std::string::npos);
  assert(diff.find("sparameter_max_frequency_hz=") != std::string::npos);
  assert(diff.find("receiver_raw_total_points=") != std::string::npos);
  assert(diff.find("receiver_comp_total_points=") != std::string::npos);
  assert(diff.find("sparameter_total_points=") != std::string::npos);
  assert(diff.find("receiver_raw_max_point_ratio=") != std::string::npos);
  assert(diff.find("receiver_raw_max_point_zone=") != std::string::npos);
  assert(diff.find("receiver_comp_max_point_ratio=") != std::string::npos);
  assert(diff.find("receiver_comp_max_point_zone=") != std::string::npos);
  assert(diff.find("sparameter_max_point_ratio=") != std::string::npos);
  assert(diff.find("sparameter_max_point_zone=") != std::string::npos);
  ...
  assert(diff.find("worst_max_risk_level=") != std::string::npos);
  ...
  assert(diff.find("worst_digest=") != std::string::npos);

  const std::size_t receiverRawDigestPos = diff.find("receiver_raw_digest=");
  const std::size_t receiverCompDigestPos = diff.find("receiver_comp_digest=");
  const std::size_t sParameterDigestPos = diff.find("sparameter_digest=");
  const std::size_t worstDigestPos = diff.find("worst_digest=");
  const std::size_t overallDigestPos = diff.find("overall_digest=");
  ...
  assert(diff.find("worst_actual_real=") != std::string::npos);
  assert(diff.find("worst_actual_imag=") != std::string::npos);
  assert(diff.find("receiver_raw_max_expected_real=") != std::string::npos);
  assert(diff.find("receiver_raw_max_actual_real=") != std::string::npos);
  assert(diff.find("receiver_comp_max_expected_real=") != std::string::npos);
  assert(diff.find("receiver_comp_max_actual_real=") != std::string::npos);
  assert(diff.find("sparameter_max_expected_real=") != std::string::npos);
  assert(diff.find("sparameter_max_actual_real=") != std::string::npos);
