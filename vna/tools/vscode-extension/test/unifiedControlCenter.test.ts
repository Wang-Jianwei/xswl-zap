...
(() => {
  ...
  assert(html.includes("topologyVirtualPorts"));
  assert(html.includes("topologyBoards"));
  assert(html.includes("topologyBindingRows"));
  assert(html.includes("btnAutoBind"));
  assert(html.includes("drag-vport"));
  assert(html.includes("drop-slot"));
  assert(html.includes("board-port-slot"));
  assert(html.includes("Drop virtual port here"));
